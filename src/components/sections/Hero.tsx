...
const Hero = () => {
  ...
  return (
    <section onMouseMove={onMove} className="relative overflow-hidden bg-hero min-h-[85vh] flex items-center">
      <div className="absolute inset-0 bg-background/60 backdrop-blur-[2px]"></div>
      <img 
        src={heroImage} 
        alt="Cinematic film set with camera, lights and director's chair" 
        className="absolute inset-0 w-full h-full object-cover opacity-80 mix-blend-soft-light" 
        loading="eager" 
      />
      ...
      <div className="relative container py-24 md:py-36">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-3 cinema-title text-4xl md:text-5xl leading-tight">
            <span className="text-gradient">Varma Film Factorys</span> <br/>
            <span className="text-foreground/90 text-2xl md:text-3xl">presents a journey of love</span>
          </h1>
          <p className="mt-5 text-lg text-muted-foreground film-subtitle">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Button asChild variant="hero" size="lg" className="hover-scale relative overflow-hidden group">
